...
Provisional entries can be removed from the Experts if -- in consultation with the community -- find that they are not in use. The Experts can change a provisional entry's status to permanent at any time.
