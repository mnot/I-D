...
An arran containing strings; each string is a host (as per {{RFC3986}} Section 3.2.2). Clients
SHOULD use the WPD's proxies to access these domains, as well as for traffic generated by that
content.
