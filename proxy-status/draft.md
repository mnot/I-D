...
* Description: The intermediary generated the response locally, without attempting to connect to the next hop (e.g. in response to debug endpoint terminated at the intermediary).
* Extra Parameters: None.
* Recommended HTTP status code: 500
